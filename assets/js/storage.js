import { defaultSiteData } from "./data.js?v=20260405-local-home-2";
...
function syncStoredCurrentUser(updatedUser) {
  try {
    ...
    // Ignore malformed local current-user payloads.
  }
  ...
  try {
    ...
    // Ignore malformed session current-user payloads.
  }
}
...
export function clearTranslationHistory(userId) {
  if (!userId) {
    return [];
  }
